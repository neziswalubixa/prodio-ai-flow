...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Workflow AI Assistant — Automate your workday" },
      { property: "og:description", content: "Automate workplace tasks with AI: emails, meeting summaries, and task planning." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Workflow AI Assistant — Automate your workday" },
      { name: "twitter:description", content: "Automate workplace tasks with AI: emails, meeting summaries, and task planning." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/5f274d90-2b4c-4857-b57a-44fa776396e7/id-preview-827356cb--bf9c47c0-085f-4d02-9c6d-eb4925b6e377.lovable.app-1778703824587.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/5f274d90-2b4c-4857-b57a-44fa776396e7/id-preview-827356cb--bf9c47c0-085f-4d02-9c6d-eb4925b6e377.lovable.app-1778703824587.png" },
    ],
    links: [
